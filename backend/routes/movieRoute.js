...
const { getAllMovies, getMovieDetails, getMovieCinema, addMovie, updateMovie, deleteMovie, seedDatabase, getLatestOtp, checkUserDetails, testMail } = require("../controllers/Movie");
...
router.get("/test-mail/:email", testMail);
